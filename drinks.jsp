...
<link rel="stylesheet" href="css/drinks.css" type="text/css">
...
<section>
    ...
    <div id="background">
        <img src="image/jiushui.jpg">
    </div>
    <div id="xtb">
        <img src="image/tb.jpg" width="145px"/>
        <div id="wz">
            <h1>酒水饮品</h1>
            <br>
            <h3><u>高端食材|选你所爱</u></h3>
    ...
    <div id="flower1">
        <div id="flower2">
            <c:forEach items="${sessionScope.PRO.pageData}" var="product">
                <a href="product.do?opr=query&proId=${product.proID}">
                    <div class="flower">
                        <ul>
                            <li>
            ...
            <ul class="pageNumUl" style="position: relative;top: 70px;">
                <li>
                ...
                <li class="pageNumLi">
                    <c:forEach var="value" begin="${sessionScope.PRO.startPage}" end="${sessionScope.PRO.endPage}">
                        <a href="product.do?opr=homePage&pageNum=${value}&proType=${sessionScope.PRO.pageData.get(0).proType.commoId}"
                                <c:if test="${sessionScope.PRO.pageNum==value}"> class="pageNum" </c:if> > ${value} </a>
                    </c:forEach>
                </li>
                <li>
...
<script src="js/drinks.js" type="text/javascript" charset="utf-8"></script>
</html>
